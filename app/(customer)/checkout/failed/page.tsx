...
const CustomerCheckoutFailedPage = () => {
          ...
          <div className="p-8 md:p-12">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-gray-400 font-medium text-sm">
                Don't worry, your cart items have been saved. You can try again anytime.
              </p>
            </div>
                ...
                <div className="bg-amber-50 border border-amber-100 rounded-3xl p-6 flex items-start text-left gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-amber-800/80 font-medium leading-relaxed">
                      Your cart items have been saved. No payment has been processed, and you haven't been charged for this transaction.
                    </p>
                  </div>
                </div>
...
export default CustomerCheckoutFailedPage;
