  ...
  return (
    <div className="flex items-stretch gap-4">
      ...
      <motion.div 
        ...
        className="bg-white p-8 rounded-5xl shadow-soft border border-jozi-forest/5 flex items-center space-x-6 min-w-[320px]"
      >
        <div className="w-20 h-20 bg-jozi-gold rounded-3xl flex items-center justify-center text-jozi-dark shadow-xl shadow-jozi-gold/20">
      ...
      {/* Mini Stats Card */}
      <div className="hidden sm:flex flex-col justify-between bg-jozi-forest p-6 rounded-4xl text-white space-y-4">
