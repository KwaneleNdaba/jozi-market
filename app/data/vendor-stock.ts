...
export const products: Product[] = [
  {
    ...
    // Fix: Added missing required properties for ProductVariant to satisfy the interface
    variants: [
      { id: 'v1-size', name: 'Size Option', sku: 'p1-size', price: 1250, stock: 15, type: 'Size', options: ['S', 'M', 'L', 'XL'] }
    ]
  },
  {
    id: 'p2',
