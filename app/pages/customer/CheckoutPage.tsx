            ...
            >
              ...
              >
                ...
                <div className="pt-8 border-t border-gray-100 flex flex-col sm:flex-row gap-4">
                  <Link href="/profile" className="flex-grow bg-jozi-forest text-white py-5 rounded-2xl font-black uppercase tracking-widest hover:bg-jozi-dark transition-all">Track My Order</Link>
                  <Link href="/" className="flex-grow bg-jozi-cream text-jozi-forest py-5 rounded-2xl font-black uppercase tracking-widest">Back to Market</Link>
                </div>
              </motion.div>
            </motion.div>
          )}
