...
const ProfilePage: React.FC = () => {
  ...
  const sidebarUser = user ? {
    ...
    level: 22, // TODO: Calculate from user data or loyalty tier
    points: 1250, // TODO: Get from user data (loyaltyPoints)
  } : {
    name: 'Loading...',
    email: '',
                  ...
                  {activeTab === 'overview' && (
                    <div className="space-y-8 text-left">
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {[
                          { label: 'Market Points', value: '1,250', icon: Star, color: 'text-jozi-gold' }, // TODO: Get from user.loyaltyPoints
                          { label: 'Active Streak', value: '4 Days', icon: Flame, color: 'text-orange-500' }, // TODO: Calculate from user data
                          { label: 'Total Saved', value: 'R1,420', icon: Zap, color: 'text-emerald-500' }, // TODO: Calculate from orders
                        ].map((stat, i) => (
