    ...
    <div className="min-h-screen bg-jozi-cream flex items-center justify-center p-4 md:p-8">
      ...
      >
          ...
          <div className="relative z-10 h-full p-16 flex flex-col justify-between text-white text-left">
            ...
            <div className="space-y-6">
              <h2 className="text-5xl font-black leading-tight tracking-tighter">
                RECLAIM YOUR <br />
                <span className="text-jozi-gold italic">ACCESS.</span>
              </h2>
              <p className="text-jozi-cream/60 text-lg font-medium max-w-md">
                Our artisanal security protocol ensures your treasures and points remain yours alone.
              </p>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <p className="text-[10px] font-black uppercase tracking-[0.3em] text-white/40">Secured by Jozi Vault</p>
            </div>
          </div>
        </div>
        ...
        <div className="lg:w-1/2 p-8 md:p-16 lg:p-24 flex flex-col justify-center bg-white">
          <div className="mb-12">
            <Link href="/signin" className="inline-flex items-center space-x-2 text-jozi-forest font-black uppercase text-[10px] tracking-widest hover:text-jozi-gold transition-colors">
          ...
          <AnimatePresence mode="wait">
            {step === 'email' && (
              ...
              >
                <div className="space-y-3">
                  <h2 className="text-4xl font-black text-jozi-forest tracking-tighter uppercase leading-none">Forgot <br /><span className="text-jozi-gold">Cipher?</span></h2>
                  <p className="text-gray-400 font-medium">Enter your registered email to receive a secure OTP.</p>
                </div>
            ...
            {step === 'otp' && (
              ...
              >
                <div className="space-y-3">
                  ...
                  <h2 className="text-4xl font-black text-jozi-forest tracking-tighter uppercase leading-none">Verify <br /><span className="text-jozi-gold">Transmission.</span></h2>
                  <p className="text-gray-400 font-medium">We've sent a 6-digit code to <span className="text-jozi-forest font-bold">{email}</span>.</p>
                </div>
                    ...
                    <div className="flex justify-between gap-2">
                      {otp.map((digit, i) => (
                        <input
                          ...
                          className={`w-12 h-16 md:w-16 md:h-20 bg-jozi-cream rounded-2xl border-2 text-center font-black text-3xl text-jozi-forest focus:border-jozi-gold/30 outline-none transition-all shadow-inner ${
            ...
            {step === 'reset' && (
              ...
              >
                <div className="space-y-3">
                  ...
                  <h2 className="text-4xl font-black text-jozi-forest tracking-tighter uppercase leading-none">New <br /><span className="text-jozi-gold italic">Cipher.</span></h2>
                  <p className="text-gray-400 font-medium">Create a strong, unique password for your artisan journey.</p>
                </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input 
                        ...
                        className={`w-full bg-jozi-cream border-2 rounded-2xl py-5 pl-16 pr-14 font-black text-jozi-forest outline-none transition-all ${
            ...
            {step === 'success' && (
              ...
              >
                ...
                <div className="space-y-3">
                  <h2 className="text-4xl font-black text-jozi-forest tracking-tighter uppercase leading-none">Cipher <br /><span className="text-emerald-500">Updated.</span></h2>
                  <p className="text-gray-400 font-medium">Your access has been successfully re-initialized. You can now sign in with your new credentials.</p>
                </div>
                <Link 
                  href="/signin" 
          ...
          <div className="mt-12 p-8 bg-jozi-gold/5 rounded-[2.5rem] border border-jozi-gold/10 text-left relative overflow-hidden group">
            ...
            <div className="relative z-10 flex items-start space-x-4">
              ...
              <div>
                <p className="text-[10px] font-black uppercase tracking-widest text-jozi-gold mb-1">Facing Issues?</p>
                <p className="text-xs text-gray-500 leading-relaxed">
                  If you no longer have access to your registered email, contact our <span className="font-bold text-jozi-forest hover:underline cursor-pointer">Hub Stewards</span> for identity verification.
                </p>
              </div>
            </div>
          </div>
